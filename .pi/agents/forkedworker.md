...
inheritSkills: false
tools: read, grep, find, ls, bash, fuzzy_edit, write, container_exec, contact_supervisor
subagentOnlyExtensions: ../extensions/harnesskit.ts, ../extensions/container_exec.ts
defaultContext: fork
